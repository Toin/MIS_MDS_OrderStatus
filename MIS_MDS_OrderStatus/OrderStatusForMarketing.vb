Module OrderStatusForMarketing

    Sub OrderStatusForMarketing_FormEntry()
        ...
        Catch ex As Exception
            ...
            STMTQuery = "EXEC Get_OrderStatusForMKT " _
                + " '" + IIf(oForm.Items.Item("CustGroup").Specific.string = "", "", oForm.Items.Item("CustGroup").Specific.string) _
    ...
    Sub RearrangeOrderStatusForMKTGrid(ByVal oForm As SAPbouiCOM.Form)
        ...
        oSODelvMassUpdateGrid.Columns.Item("Stock Avail").Width = 70
        ...
        oSODelvMassUpdateGrid.Columns.Item("Delivery Date, Plan, Last").Width = 100
        ...
        oSODelvMassUpdateGrid.Columns.Item("Delivery Date, Plan, Last").Editable = False
    ...
    Function ValidateInputDueDate_Form_OrderStatusForMarketing(ByVal oForm As SAPbouiCOM.Form)
    ...
    Sub LoadOrderStatusForMarketing(ByVal oForm As SAPbouiCOM.Form)
        Dim STMTQuery As String
